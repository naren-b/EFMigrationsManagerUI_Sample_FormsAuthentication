[assembly: WebActivatorEx.PreApplicationStartMethod(typeof(FormsAuthentication.EFMigrationsManagerConfig), "Register")]
namespace FormsAuthentication
{
	using FormsAuthentication.Controllers;
    ...
    public static class EFMigrationsManagerConfig
    {
        ...
        public static void Register()
        {
            ...
            EFMigrationsManagerSettings.SetEFConfiguration(new EFConfiguration());
